...
public:
	// STATIC CONSTANTS
	static const int BLOCK_WIDTH = 32;			  // pixel width of a tetris block, init to 32
	static const int BLOCK_HEIGHT = 32;   // pixel height of a tetris block, init to 32
  static const int SCORE_PER_ROW = 50;
  constexpr static const double MAX_SECONDS_PER_TICK = 0.75; // the slowest "tick" rate (in seconds), init to 0.75
	constexpr static const double MIN_SECONDS_PER_TICK = 0.2; // the fastest "tick" rate (in seconds), init to 0.20
...
private:
  ...
  bool doesShapeIntersectLockedBlocks(const GridTetromino& shape) const;
